...
class SpotAPI(Client):
    ...
    # 市价单
    # params = [
    #   {"client_oid":"20180728","instrument_id":"btc-usdt","side":"sell","type":"market","notional":"10001","margin_trading ":"1"},
    #   {"client_oid":"20180728","instrument_id":"btc-usdt","side":"buy","type":"market","notional":"10002","margin_trading ":"1"}
    # ]
